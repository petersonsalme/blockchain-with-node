...
describe('Blockchain', () => {
    ...
    describe('isValidChain()', () => {
        ...
        describe('when the chain does starts with the genesis block and has multiple blocks', () => {
            beforeEach(() => {
                let transaction = new Wallet().createTransaction({ recipient: 'Bears-address', amount: 1});
                blockchain.addBlock({ data: [transaction]});

                transaction = new Wallet().createTransaction({ recipient: 'Beets-address', amount: 2});
                blockchain.addBlock({ data: [transaction]});

                transaction = new Wallet().createTransaction({ recipient: 'Battlestar-Galactica-address', amount: 3});
                blockchain.addBlock({ data: [transaction]});
            });
